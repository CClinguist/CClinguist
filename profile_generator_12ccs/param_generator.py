...
def generate_params():
    ...
    for _ in range(5):
        ...
        coef_obvious_penalty = sample_from_dual_ranges((coef_obvious_penalty_base-15,coef_obvious_penalty_base-9),
                                                       (coef_obvious_penalty_base+10,coef_obvious_penalty_base+15))
    ...
    for _ in range(5):
        ...
        coef_acc_reward = sample_from_dual_ranges((coef_acc_reward_base-7,coef_acc_reward_base-4),
                                                  (coef_acc_reward_base+9,coef_acc_reward_base+15))
    ...
    for _ in range(5):
        ...
        coef_search_penalty = sample_from_dual_ranges((coef_search_penalty_base-5,coef_search_penalty_base-3),
                                                      (coef_search_penalty_base+9,coef_search_penalty_base+15))
    ...
    for _ in range(5):
        ...
        new_base_penalty = sample_from_dual_ranges((base_penalty-7,base_penalty-4),
                                                   (base_penalty+7,base_penalty+10))
    ...
    for _ in range(5):
        ...
        new_direction_penalty = sample_from_dual_ranges((direction_penalty-17,direction_penalty-15),
                                                        (direction_penalty+20,direction_penalty+30))
...
print("Generated params_train.json with the specified data.")
