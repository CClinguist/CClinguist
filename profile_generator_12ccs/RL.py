...
class PPO(nn.Module):
    ...
    def cal_reward_test(self,action,state,dtw_matrix,continue_flag,t,max_deepth):
        ...
        dtw_action=torch.index_select(dtw_matrix,0,action.int()-1)  
        reward=torch.einsum('bij,bjk->bik',state.unsqueeze(1),dtw_action) 
    ...
    def test_output(self):
        ...
        rewards = rewards.to(self.opts.device)  
