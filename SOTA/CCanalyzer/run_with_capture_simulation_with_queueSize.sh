...
timeout 20s mm-delay $DELAY_TIME ./curl_simulation_with_queueSize.sh  None None $TARGET_IP $INTERVAL_TIME 1 &
...
sudo tcpdump -i delay-$second_pid -w $CAPTURE_FILE host "47.76.60.27"
